...
const MoneyDashboard = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-2 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-gray-800 dark:via-gray-800 dark:to-gray-900 rounded-2xl shadow">
